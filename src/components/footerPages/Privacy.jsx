      ...
      return(
         <div className='info'>
            <div className="info__inner">
               ...
               <p>PLEASE NOTE: Rockstar Games welcomes input from the gaming community. However, any submissions to Rockstar Games of any nature whatsoever, whether through this site or otherwise, and whether via electronic or other mean, become the sole and exclusive property of Rockstar Games, which shall have full right, title and interest thereto, including under copyright, in all media now existing or hereafter created, and without any obligation to account or make any payment to the submitter for any use thereof. No purported reservation of rights incorporated in or accompanying any submission shall have any force or effect. By making a submission to Rockstar Games, you hereby agree to all of the foregoing. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolores maiores assumenda doloremque sit laborum placeat distinctio magnam consequatur repudiandae, animi fugit veniam illum magni quod fuga! Corporis voluptates sapiente eligendi.lorem Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam consequatur sint rem consectetur maxime deserunt voluptas quo reiciendis tempora reprehenderit delectus tempore, blanditiis quis est quos unde quae labore praesentium.</p>
